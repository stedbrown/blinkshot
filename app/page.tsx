              ...
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 max-w-2xl mx-auto hover-lift">
                ...
                <div className="flex items-center justify-center gap-2 text-purple-100">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-cyan-300 hover:text-white transition-colors duration-200 font-semibold flex items-center gap-1 hover:scale-105 transform"
                  >
                    <span>Stefano Vananti</span>
